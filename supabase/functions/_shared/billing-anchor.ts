...
/** 1st of the month on or after (today + 30 days), Europe/London. */
export function nextBillingAnchor(from = new Date()): Date {
...
export function formatBillingAnchor(date: Date): string {
