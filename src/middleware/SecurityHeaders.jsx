...
export function SecurityHeaders() {
  useEffect(() => {
    ...
    addMetaTag(
      ...
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://maps.googleapis.com https://connect.facebook.net https://cdn-eu.pagesense.io https://www.clarity.ms https://scripts.clarity.ms https://salesiq.zoho.eu https://js.zohocdn.com https://www.googletagmanager.com https://www.google-analytics.com; script-src-elem 'self' 'unsafe-inline' https://js.stripe.com https://maps.googleapis.com https://connect.facebook.net https://cdn-eu.pagesense.io https://www.clarity.ms https://scripts.clarity.ms https://salesiq.zoho.eu https://js.zohocdn.com https://www.googletagmanager.com https://www.google-analytics.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.jsdelivr.net https://css.zohocdn.com; style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.jsdelivr.net https://css.zohocdn.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://api.stripe.com https://*.supabase.co https://supabase.wearemaster.com https://api.openai.com https://maps.googleapis.com https://connect.facebook.net https://www.facebook.com https://www.clarity.ms https://salesiq.zoho.eu https://pagesense-collect.zoho.eu https://*.a.run.app https://*.conversionsapigateway.com https://www.googletagmanager.com https://www.google-analytics.com https://tagassistant.google.com; frame-src https://js.stripe.com;"
    )
