  ...
  const segs = [
    {
      ...
      h: 'Manage portfolios, compliance and maintenance across every asset.',
      d: 'From listed estates to build-to-rent, keep units compliant and tenants looked after — with spend and SLAs visible per asset, building and region.',
    ...
    },
    {
      ...
      h: 'Standardise maintenance across every location.',
      d: 'Protect brand and revenue uptime across sites. One playbook, enforced everywhere, with franchisee-level visibility and head-office control.',
    ...
    },
    {
      ...
      h: 'Handle high-volume requests with consistent delivery and reporting.',
      d: 'Run complex compliance regimes at scale — with the audit trail, approvals and analytics enterprise teams need.',
    ...
    },
    {
      ...
      h: 'Plug into our infrastructure to manage jobs, suppliers and reporting at scale.',
      d: 'Embed vetted supply, dispatch and tracking into your own product. We run the trade network; you keep the customer relationship.',
