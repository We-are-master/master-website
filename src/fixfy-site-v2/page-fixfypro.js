    ...
    <div class="v2-hero-grid">
      <div class="v2-hero-copy">
        ...
        <div class="v2-hero-cta">
          <a href="https://partners.getfixfy.com/get-started" class="v2-btn v2-btn-primary">Start FixfyPro <span class="arr">→</span></a>
...
<section class="v2-int">
  <div class="v2-container">
    ...
    <div style="margin-top:48px;display:flex;gap:12px;flex-wrap:wrap">
      ...
      <a href="https://partners.getfixfy.com/get-started" class="v2-btn v2-btn-outline">Start FixfyPro · 7 days free</a>
    </div>
  </div>
</section>
...
<section class="v2-section dark" id="pricing">
  <div class="v2-container">
    ...
    <div class="v2-pricing-card">
      ...
      <a href="https://partners.getfixfy.com/get-started" class="v2-btn v2-btn-primary" style="width:100%;justify-content:center">Start FixfyPro <span class="arr">→</span></a>
