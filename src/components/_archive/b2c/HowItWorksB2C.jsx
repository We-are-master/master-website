...
const HowItWorksB2C = () => {
  const steps = [
    { number: 1, icon: <Search size={40} />, title: 'Describe the job', description: "Explain what you need and we'll handle the rest.", color: '#ED4B00' },
    { number: 2, icon: <CreditCard size={40} />, title: 'Create your booking', description: 'Transparent pricing, clear options, no hidden costs.', color: '#ED4B00' },
    { number: 3, icon: <UserCheck size={40} />, title: 'Get it done!', description: 'We will match you internally with a trusted local professional, it will be managed by Fixfy.', color: '#ED4B00' }
  ];
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '100%', overflow: 'hidden' }}>
        ...
        >
          ...
          <p style={{
            ...
            <span style={{ color: '#ED4B00', fontWeight: '700', fontFamily: 'inherit' }}>price upfront</span>
            {' '}— before you commit.
          </p>
        </motion.div>
