...
const benefits = [
  { icon: <Crown size={24} />, title: 'Member pricing up to 50% off in any services', description: 'Private rates on every service you book.', color: '#ED4B00' },
  { icon: <CheckCircle size={24} />, title: '3 interest-free instalments', description: 'Spread the cost with no extra charges.', color: '#ED4B00' },
  { icon: <Clock size={24} />, title: 'Priority booking', description: 'Jump the queue for standard and urgent jobs.', color: '#ED4B00' },
  { icon: <Shield size={24} />, title: 'Every job covered by our insurance', description: 'Fully vetted, insured professionals on every job.', color: '#ED4B00' },
  { icon: <Clock size={24} />, title: 'Same Day availability', description: 'Get help when you need it most.', color: '#ED4B00' },
  { icon: <Infinity size={24} />, title: 'Unlimited use', description: 'Use your member benefits as often as you need. Fair use applies.', color: '#ED4B00' }
];
