              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                {[
                  ...
                  <a
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.backgroundColor = '#ED4B00';
            ...
            <motion.div className="footer-column" variants={fadeInUp} transition={defaultTransition}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  {[
                    { icon: Phone, text: '+44 7983 182332', subtext: 'Mon-Sun, 8am-8pm', color: '#ED4B00' },
                    { icon: Mail, text: 'hello@getfixfy.com', subtext: null, color: '#ED4B00' },
                    { icon: MapPin, text: 'London, UK', subtext: 'Serving Greater London', color: '#ED4B00' }
                  ].map((contact, index) => (
