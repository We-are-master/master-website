...
const PopularServicesB2C = () => {
  ...
  const popularServices = [
    { icon: <Tv size={32} />, title: 'TV mounting', description: 'Professional TV installation and mounting service', image: '/Tv Mount.png', color: '#ED4B00' },
    { icon: <Wrench size={32} />, title: 'Odd jobs', description: 'General handyman services for your home', image: '/Odd Jobs.png', color: '#ED4B00' },
    { icon: <Package size={32} />, title: 'Flatpack assembly', description: 'Furniture assembly and installation', image: '/Flat Assemble.png', color: '#ED4B00' },
    { icon: <Lightbulb size={32} />, title: 'Light fitting replacement', description: 'Professional light installation and replacement', image: '/Light Fitting.png', color: '#ED4B00' },
    { icon: <Sparkles size={32} />, title: 'Cleaning services', description: 'Deep clean, end of tenancy, and more', image: '/Cleaning.png', color: '#ED4B00' },
    { icon: <Droplets size={32} />, title: 'Plumbing', description: 'Emergency repairs and installations', image: '/Plumber.png', color: '#ED4B00' },
    { icon: <Zap size={32} />, title: 'Electrical', description: 'Safe and certified electrical work', image: '/electrician.png', color: '#ED4B00' },
    { icon: <Hammer size={32} />, title: 'Carpentry', description: 'Custom woodwork and repairs', image: '/7.png', color: '#ED4B00' }
  ];
