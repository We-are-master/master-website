        ...
        <div className="hero-b2c-content" style={{ maxWidth: 'min(1120px, 94vw)', margin: '0 auto', textAlign: 'center', paddingLeft: 'clamp(0.5rem, 2vw, 1rem)', paddingRight: 'clamp(0.5rem, 2vw, 1rem)' }}>
          ...
          >
            <>
              ...
              <span style={{ color: '#ED4B00', fontWeight: '600', display: 'inline-block' }}>
              ...
              <div style={{
                ...
                {!searchTerm && (
                  ...
                  >
                    ...
                    <span className="hero-placeholder-service" style={{ color: '#ED4B00', fontSize: 'clamp(1rem, 4vw, 1.125rem)', fontFamily: 'inherit', fontWeight: '500', whiteSpace: 'nowrap' }}>{displayedText}</span>
                    <span style={{
                      width: '2px',
          ...
          >
            {trustItems.map((text, index) => (
              ...
              >
                <span style={{ color: '#ED4B00', fontSize: '0.875rem', fontWeight: '600' }}>✓</span>
                <span>{text}</span>
              </motion.div>
            ))}
          </motion.div>
