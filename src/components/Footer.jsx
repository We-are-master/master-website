          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem'}}>
            ...
            <div>
              ...
              <ul style={{listStyle: 'none', padding: 0}}>
                ...
                <li style={{marginBottom: '0.75rem'}}><a href="https://partners.getfixfy.com/get-started" style={{color: 'white', textDecoration: 'none', transition: 'color 0.3s ease'}}>Become a Partner</a></li>
              </ul>
            </div>
