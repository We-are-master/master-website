...
const B2CCleaningBooking = () => {
  ...
  useEffect(() => {
    calculatePrice();
  }, [bedrooms, bathrooms, selectedAddons]);
  ...
  return (
    <>
      ...
      <div className="dark" style={{
        minHeight: '100dvh',
        background: 'linear-gradient(180deg, #0A0A2E 0%, #020030 100%)',
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', padding: '16px 20px', justifyContent: 'space-between' }}>
          ...
          {/* Service Tabs */}
          <div style={{ padding: '0 20px', paddingTop: '32px', paddingBottom: '16px', overflow: 'visible' }}>
            <div style={{ 
              display: 'flex', 
              overflowX: 'auto', 
              ...
              {services.map((service) => (
                <div key={service.id} style={{ scrollSnapAlign: 'center', flexShrink: 0, width: '140px', paddingTop: '16px' }}>
                  <button
          ...
          {/* Progress Bar */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '0 20px 16px' }}>
        ...
        <footer style={{
          ...
          <div style={{ maxWidth: '448px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '14px' }}>
            {/* AI Analysis Card */}
            <div style={{
              background: '#0A0A2E',
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 4px' }}>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <span style={{ color: 'rgba(255, 255, 255, 0.4)', fontSize: '9px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                  Estimated Quote
                </span>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '2px' }}>
                  <span style={{ fontSize: '30px', fontWeight: 900, color: 'white', letterSpacing: '-0.05em' }}>
                    £{estimatedPrice}
                  </span>
                  <span style={{ color: 'rgba(255, 255, 255, 0.4)', fontSize: '12px', fontWeight: 700 }}>.00</span>
                </div>
              </div>
