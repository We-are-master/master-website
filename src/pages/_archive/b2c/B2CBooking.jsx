  ...
  if (submitted) {
    return (
      <div style={{
        ...
        <CheckCircle size={48} style={{ color: '#ED4B00', marginBottom: '1rem' }} />
  ...
  if (!showForm) {
    return (
      <div style={{
        ...
        background: 'linear-gradient(135deg, #ED4B00 0%, #d13d00 100%)',
        borderRadius: '1rem',
        boxShadow: '0 4px 6px rgba(0,0,0,0.05)',
        border: '1px solid #e5e7eb',
        color: 'white'
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '0.5rem' }}>
          <button
            ...
            style={{
              flex: 1,
              backgroundColor: submitting ? '#9ca3af' : '#ED4B00',
              color: 'white',
              border: 'none',
              borderRadius: '0.5rem',
              padding: '0.75rem 1.5rem',
      ...
      <div style={{
        ...
        <div className="container">
          <button
            ...
            onMouseEnter={(e) => e.target.style.color = '#ED4B00'}
          ...
          <div style={{
            ...
            <form onSubmit={handleDescriptionSubmit}>
              ...
              <button
                ...
                onMouseOut={(e) => e.target.style.backgroundColor = '#020040'}
              >
                Continue
          ...
          <div style={{
            ...
            {jobDescription && (
              <p style={{
                ...
                Service: <strong style={{ color: '#ED4B00', fontWeight: '600' }}>{jobDescription}</strong>
              </p>
            )}
            <p style={{
              color: '#86868b',
                  ...
                  >
                    ...
                    <input
                      ...
                      onFocus={(e) => {
                        const container = document.getElementById('postcode-container');
                        if (container) {
                          container.style.borderColor = '#ED4B00'
            ...
            <div className="booking-step3-services-grid">
                  ...
                  >
                    ...
                    <div className="booking-step3-card-content" style={{ padding: '1rem 1.25rem 1.25rem' }}>
                      ...
                      <button
                        ...
                        style={{
                          width: '100%',
                          backgroundColor: isInCart(service.id) ? '#ED4B00' : '#020040',
                          color: 'white',
                          border: 'none',
                          borderRadius: '0.5rem',
                          padding: '0.875rem',
                        ...
                        onMouseOut={(e) => {
                          if (!isInCart(service.id)) {
                            e.target.style.backgroundColor = '#020040';
                            e.target.style.transform = 'scale(1)';
                          }
                        }}
                      >
              ...
              >
                ...
                <div style={{ borderTop: '1px solid #f3f4f6', paddingTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '1rem', fontWeight: '700', color: '#020040', marginTop: '0.25rem', fontFamily: BRAND_FONT }}>
                    <span>Total</span>
