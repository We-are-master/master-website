      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            onMouseOut={(e) => e.target.style.backgroundColor = '#0A0A2E'}
          >
            Return to Booking
          </button>
        </div>
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <Loader2 size={48} style={{ animation: 'spin 1s linear infinite', margin: '0 auto 1.5rem', color: '#0A0A2E' }} />
      ...
      <div style={{
        ...
        <div style={{ padding: '2rem' }}>
          ...
          <p style={{
            ...
            <a 
              href="mailto:hello@getfixfy.com" 
              style={{ color: '#020040', textDecoration: 'none' }}
            >
              hello@getfixfy.com
            </a>
          </p>
