      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            ...
            <motion.div
              ...
              style={{
                width: '72px',
                height: '72px',
                backgroundColor: step === 'success' ? '#10b981' : step === 'code' ? '#8b5cf6' : '#0A0A2E',
                borderRadius: '16px',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
          ...
          {step === 'code' && (
            <form onSubmit={handleVerifyCode}>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  backgroundColor: (loading || code.length !== 6) ? '#9ca3af' : '#ED4B00',
                  color: 'white',
                  border: 'none',
                  borderRadius: '8px',
                  padding: '1rem 2rem',
              ...
              <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                ...
                <button
                  ...
                  style={{
                    backgroundColor: 'transparent',
                    border: 'none',
                    color: resendCooldown > 0 ? '#9ca3af' : '#ED4B00',
                    fontSize: '0.9375rem',
                    fontWeight: '500',
          ...
          <div style={{
            ...
            <a href="tel:02033376168" style={{ color: '#ED4B00', textDecoration: 'none', fontWeight: '600' }}>020 3337 6168</a>
          </div>
        </motion.div>
      </div>
