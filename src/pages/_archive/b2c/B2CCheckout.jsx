    ...
    <form onSubmit={handleSubmit} style={{ width: '100%' }}>
      ...
      <button
        ...
        style={{
          ...
          background: loading 
            ? '#9ca3af' 
            : 'linear-gradient(135deg, #ED4B00 0%, #d13d00 100%)',
          color: 'white',
          border: 'none',
          borderRadius: '12px',
      ...
      <div className="bkp-main">
        ...
        <section style={{ marginBottom: 24 }}>
          <div style={{
            ...
            <p style={{ fontSize: '11px', fontWeight: 800, letterSpacing: '0.08em', color: '#0A0A2E', marginBottom: 12, textTransform: 'uppercase', opacity: 0.8 }}>
              Discount code
            </p>
            {couponApplied ? (
              ...
              <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: 10 }}>
                <input
                  ...
                  style={{ flex: 1, minWidth: 0, padding: '14px 16px', border: `2px solid ${couponError ? '#dc2626' : 'rgba(237, 75, 0, 0.3)'}`, borderRadius: '12px', fontSize: '15px', fontWeight: 600, color: '#0A0A2E', backgroundColor: '#fff' }}
                />
          ...
          {!showServiceLocationForm ? (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', minWidth: 0, flex: 1 }}>
                ...
                <span style={{ fontSize: '15px', fontWeight: 700, color: '#0A0A2E' }}>
        ...
        <section aria-labelledby="dates-heading">
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
              ...
              <span style={{ fontSize: '18px', fontWeight: 700, color: '#0A0A2E' }}>
                  ...
                  cells.push(
                    <button
                      ...
                      style={{
                        ...
                        color: disabled ? '#CBD5E1' : selected ? '#ED4B00' : '#0A0A2E',
                        fontWeight: 700,
                        fontSize: '16px',
        ...
        <section style={{ display: 'flex', justifyContent: 'center', padding: '0 8px' }} aria-live="polite">
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 2, minWidth: 0, flex: 1 }}>
              <span style={{ fontSize: '13px', fontWeight: 800, color: '#0A0A2E', whiteSpace: 'nowrap' }}>AI Verified</span>
        ...
        <section>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
              ...
              <span style={{ fontSize: '15px', fontWeight: 700, lineHeight: '1.4', color: '#0A0A2E' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  ...
                  <div>
                    <p style={{ fontSize: '18px', fontWeight: 800, lineHeight: '1.2', color: '#0A0A2E', margin: 0 }}>
                      Fixfy Club
                    </p>
                    <span style={{
                      fontSize: '11px',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <p style={{ fontSize: '15px', fontWeight: 700, color: '#0A0A2E', margin: 0 }}>
                ...
                {[
                  ...
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontSize: '14px', fontWeight: 600, color: '#0A0A2E', lineHeight: 1.35 }}>{text}</span>
                  </div>
                ))}
              </div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '20px', borderTop: '1px solid #F1F5F9' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '2px' }}>
                  <p style={{ fontSize: '20px', fontWeight: 800, color: '#0A0A2E', margin: 0 }}>
                    £{SUBSCRIPTION_PRICE.toFixed(2)}
                  </p>
                  <span style={{ fontSize: '12px', fontWeight: 600, opacity: 0.4, color: '#0A0A2E' }}>
                    /mo
                  </span>
                </div>
              </div>
        ...
        <section className="bkp-price-summary-inline" style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '15px', marginBottom: '20px' }}>
            <span style={{ opacity: 0.6, fontWeight: 600, color: '#0A0A2E' }}>Service Total</span>
            <span style={{ fontWeight: 700, color: '#0A0A2E' }}>£{serviceTotal.toFixed(2)}</span>
          </div>
          {subscriptionOfferActive && (
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '15px', marginBottom: '20px' }}>
              <span style={{ opacity: 0.6, fontWeight: 600, color: '#0A0A2E' }}>Fixfy Club Monthly</span>
              <span style={{ fontWeight: 700, color: '#0A0A2E' }}>£{SUBSCRIPTION_PRICE.toFixed(2)}</span>
            </div>
          )}
          {savingsAmount > 0 && (
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '15px', marginBottom: '20px' }}>
            <span style={{ opacity: 0.6, fontWeight: 600, color: '#0A0A2E' }}>VAT (20% included)</span>
            <span style={{ fontWeight: 700, color: '#0A0A2E' }}>£{vatAmount.toFixed(2)}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '24px', marginTop: '8px', borderTop: '1px solid #E2E8F0' }}>
            <span style={{ fontSize: '22px', fontWeight: 800, color: '#0A0A2E' }}>Total Amount</span>
            <div style={{ textAlign: 'right' }}>
              <span style={{ fontSize: '36px', fontWeight: 800, letterSpacing: '-0.02em', color: '#0A0A2E', display: 'block', lineHeight: '1' }}>
                £{finalTotal.toFixed(2)}
              </span>
              <span style={{ fontSize: '11px', fontWeight: 700, opacity: 0.4, textTransform: 'uppercase', color: '#0A0A2E' }}>
                VAT included
              </span>
            </div>
          </div>
        ...
        <section style={{ paddingBottom: isMobile ? '340px' : '16px', padding: '0 4px' }}>
          <p style={{ fontSize: '12px', fontWeight: 500, lineHeight: 1.5, opacity: 0.6, color: '#0A0A2E', margin: 0 }}>
      ...
      {isDesktop && (
        <aside className="bkp-checkout-sidebar" aria-label="Order summary">
          <div style={{ borderBottom: '1px solid var(--bkp-light-border)', paddingBottom: 20, marginBottom: 20 }}>
            ...
            <p style={{ fontSize: '17px', fontWeight: 700, color: '#0A0A2E', margin: '0 0 4px' }}>{service?.title || 'Your service'}</p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontSize: '15px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 16, marginTop: 8, borderTop: '1px solid #E2E8F0' }}>
              <span style={{ fontSize: '18px', fontWeight: 800, color: '#0A0A2E' }}>Total</span>
              <span style={{ fontSize: '28px', fontWeight: 800, letterSpacing: '-0.02em', color: '#0A0A2E' }}>£{finalTotal.toFixed(2)}</span>
            </div>
      ...
      <div className="bkp-checkout-footer-mobile" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', padding: '0 4px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <p style={{ fontSize: '10px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#0A0A2E', margin: 0 }}>
              Stripe Secure
            </p>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
